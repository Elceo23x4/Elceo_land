...
export default function ConfidenceContextPanel() {
  ...
  return (
    <PanelFrame title="Confidence & Context" eyebrow="Reasoning Matrix" compact>
      <PanelWorkspace
        title=""
        tabs={TABS}
      ...
      >
          ...
          <div>
            ...
            <div style={{ marginTop: 8 }}>
              <HoverInsightPopover
                ...
                detail={
                  <ul style={{ margin: 0, paddingLeft: "0.8rem", fontSize: "0.55rem", lineHeight: 1.7, color: "#8a8178" }}>
                    <li>Momentum: aligned with bias direction</li>
                    <li>Macro context: partially conflicting</li>
        ...
        {activeTab === "caution" && (
          <div>
            {ctx.freshness !== "fresh" && (
              <StaleDataWarning
                severity={ctx.freshness === "stale" ? "high" : "medium"}
                lastUpdatedLabel="Fixture snapshot"
              />
            )}
            <SystemNotice tone="info" title="Fixture-only context">
              <p style={{ margin: 0, fontSize: "0.55rem" }}>
                Backend guards remain source of truth. No live provider is connected.
              </p>
            </SystemNotice>
            <button
              className="elceo-panel-detail-button"
      ...
      <DetailDrawer
        ...
        subtitle="Fixture-only reasoning preview"
      ...
      >
        ...
        <div style={{ marginTop: "1rem" }}>
          <p style={{ fontSize: "0.6rem", color: "#8a8178", margin: 0 }}>
